...
const Header = () => {
  ...
  return (
    <header className=" container m-auto flex items-center justify-between w-full py-5 relative px-4 sm-px-0">
      ...
      <motion.nav
        className="z-10 sm:hidden flex flex-col gap-10 justify-center h-screen bg-[#fefaf6] dark:bg-[#0b0b0b] [box-shadow:0_4px_8px_rgba(20,_20,_20,_0.1)] dark:[box-shadow:0_7px_8px_rgba(60,_60,_60,_0.1)] fixed top-0 left-0 w-full p-[20px] border-b border-[#b5b5b5] dark:border-[#292929]"
        initial={{ y: "-110%" }}
