...
export default function Home() {
  return (
    <main className="container m-auto min-h-screen px-4 sm-px-0 overflow-hidden">
      ...
      <button className="size-[100px] my-11 hover:bg-[#000000d8] text-[20px] underline font-mono font-bold active:scale-95 transition-all  text-[#fefaf6] bg-[#0b0b0b] dark:bg-[#fefaf6] dark:text-[#0b0b0b] rounded-full">
        للحجز
      </button>
      <MarqueeCamera />
      <Gallery />
